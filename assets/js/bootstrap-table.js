...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s cantidad por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Mostrando %s a %s de %s elementos', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            this.$toolbar.find('button[name="refresh"]')
                .off('click').on('click', function(){$.proxy(this.refresh, this);location.reload();});
        }
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-right search">',
                    sprintf('<input size="30" class="form-control " type="text" placeholder="%s">',
